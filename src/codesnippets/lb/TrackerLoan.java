/**
 * This subclass contains any features or functionality specific to a Tracker Loan.
 *
 ...
 */
public class TrackerLoan extends Loans {

    public TrackerLoan(int loanID, int loanAmount, String product, int loanTerm, String completedDate) {
